...
import { Card, CardContent, CardHeader, Badge, PageTransition, StaggerContainer, StaggerItem } from '@/components/ui';
  ...
  return (
    <PageTransition className="space-y-6">
      ...
      <div>
        ...
        <p className="text-zinc-400 mt-1">Configuration et informations du compte</p>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="p-4 bg-zinc-800/50 rounded-xl">
                  <label className="text-sm text-zinc-400">Nom d&apos;utilisateur</label>
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-zinc-800/50 rounded-xl">
                  <label className="text-sm text-zinc-400">Membre depuis</label>
            ...
            <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <StaggerItem>
                <div className="p-4 bg-zinc-800/50 rounded-xl">
                  ...
                  <p className="text-xs text-zinc-500 mt-1">Tous les services sont actifs</p>
                </div>
              </StaggerItem>
              <StaggerItem>
                <div className="p-4 bg-zinc-800/50 rounded-xl">
                  ...
                  <p className="text-xs text-zinc-500 mt-1">Dashboard Next.js</p>
                </div>
              </StaggerItem>
              <StaggerItem>
                <div className="p-4 bg-zinc-800/50 rounded-xl">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-zinc-400 text-sm">Base de données</span>
                  </div>
                  <p className="text-white font-medium text-lg">PostgreSQL 16</p>
                  <p className="text-xs text-zinc-500 mt-1">Connexion active</p>
                </div>
              </StaggerItem>
            </StaggerContainer>
          </CardContent>
            ...
            <StaggerContainer className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <StaggerItem>
                <div className="p-3 bg-emerald-500/10 border border-emerald-500/30 rounded-xl text-center">
                  ...
                  <p className="text-xs text-zinc-400">Lecture & Upload</p>
                </div>
              </StaggerItem>
              <StaggerItem>
                <div className="p-3 bg-emerald-500/10 border border-emerald-500/30 rounded-xl text-center">
                  ...
                  <p className="text-xs text-zinc-400">Création & Gestion</p>
                </div>
              </StaggerItem>
              <StaggerItem>
                <div className="p-3 bg-emerald-500/10 border border-emerald-500/30 rounded-xl text-center">
                  ...
                  <p className="text-xs text-zinc-400">Consultation</p>
                </div>
              </StaggerItem>
              <StaggerItem>
                {user?.role === 'superadmin' ? (
                  <div className="p-3 bg-indigo-500/10 border border-indigo-500/30 rounded-xl text-center">
                    ...
                    <p className="text-xs text-zinc-400">Accès complet</p>
                  </div>
                ) : (
                  <div className="p-3 bg-zinc-800/50 border border-zinc-700 rounded-xl text-center opacity-50">
                    <Shield className="w-6 h-6 text-zinc-500 mx-auto mb-2" />
                    <p className="text-sm text-zinc-400 font-medium">Admin</p>
